...
socket.on("audioStreamResponse", function (data) {
  ...
  if (data.audioData) {
    console.log("🎵 Audio chunk received (30s):", data.audioData.length, "chars (base64)");
    ...
    try {
      ...
      console.log("🎯 Audio element updated with new 30-second chunk");
      
      // Otomatik oynat
      audioElement.play().then(() => {
        console.log("✅ Audio playing successfully (30s chunk)");
      }).catch(e => {
